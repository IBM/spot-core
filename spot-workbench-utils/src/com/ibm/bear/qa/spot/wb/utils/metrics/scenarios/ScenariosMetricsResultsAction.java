...
//	// Sort results
//	Collections.sort(scenarioResults.scenarios);
//
//	/*
//	 * Compute steps and tests numbers int allSteps = 0; int allTests = 0; for (Scenario scenario: scenarioResults.scenarios) { allSteps += scenario.steps.size(); allTests += scenario.getTestsNumber(); }
//	 */
//
//	// Display result
//	StringBuilder resultText = new StringBuilder("Metrics for workspace scenarios:")
//	    .append(LINE_SEPARATOR);
//	StringBuilder clipboardText = new StringBuilder();
//	for (Scenario scenario : scenarioResults.scenarios) {
//		switch (scenario.getType()) {
//			case Pipeline:
//			case Monitored:
//			case Private:
//			case Perfs:
//				clipboardText.append(scenario.getName())
//				    .append('\t')
...
//	    .append("----------------------------------------")
//	    .append(LINE_SEPARATOR)
//	    .append(scenarioResults.getCountableScenarios().size())
//	    .append('\t')
//	    .append(scenarioResults.getAllRunSteps())
//	    .append('\t')
//	    .append(scenarioResults.getAllRunTests())
//	    .append(LINE_SEPARATOR)
//	    .append("Implemented\t")
//	    .append(scenarioResults.getAllImplementedSteps())
//	    .append('\t')
//	    .append(scenarioResults.getAllImplementedTests())
//	    .append(LINE_SEPARATOR);
//	resultText
//	    .append(clipboardText)
//	    .append(LINE_SEPARATOR)
//	    .append("Text above will be put in clipboard when closing this dialog...");
//	MessageDialog.openInformation(getShell(), "SPOT Metrics", resultText.toString());
//
//	// Copy to clipboard
//	copyToClipboard(clipboardText.toString());
}
}